# Documentação do QuickPaste

Organizada pelo modelo [Diátaxis](https://diataxis.fr), que separa a documentação por objetivo do
leitor:
...
- [EXPERIMENT_REPORT.md](EXPERIMENT_REPORT.md) — relatório do experimento de reformulação do editor.
